      ...
      <div className="reservation__inner">
        ...
        {submitted ? (
          <div className="reservation__success">
            <p className="reservation__success-title">Merci !</p>
            <p className="reservation__success-text">
              Votre demande de réservation a été envoyée. Nous vous contacterons sous peu.
            </p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="reservation__form">
            ...
            <div className="reservation__grid-3">
              <div className="reservation__field">
                ...
                <input type="date" required className="reservation__input" />
              </div>
              <div className="reservation__field">
                <label className="reservation__label">Heure</label>
                <select required className="reservation__select">
